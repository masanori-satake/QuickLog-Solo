...
| Test | **テスト: E2E** | `test_e2e.yml` | Playwright による End-to-End テスト | `main`へのPush/PR, 手動 |
| Test | **テスト: アニメーション品質** | `test_animation.yml` | アニメーションモジュールの品質（描画率、変化率）評価 | `main`へのPush/PR (*1), 手動 |
