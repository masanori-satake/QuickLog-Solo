...
- ページネーション（1ページ8項目）をサポート。マウスホイールで切り替え可能。
...
## 8. 追加合意事項
### デザイン・UI
- **経過時間表示:** リアルタイム表示（HH:MM:SS）。
- **背景アニメーション:** 実行中エリアの背景が1分周期でアニメーション。
- **確認ダイアログ:** アプリ内カスタムダイアログを実装。
- **色の判別性向上:** 似通った系統の色（緑系、灰色系、赤系など）を整理し、一目で区別が付くように調整。
