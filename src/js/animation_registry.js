...
export const animations = [
    { id: 'car-drive', class: CarDrive, metadata: CarDrive.metadata },
    { id: 'cats', class: Cats, metadata: Cats.metadata },
    { id: 'clock', class: Clock, metadata: Clock.metadata },
    { id: 'coffee-drip', class: CoffeeDrip, metadata: CoffeeDrip.metadata },
    { id: 'contour-lines', class: ContourLines, metadata: ContourLines.metadata },
    { id: 'dot-typing', class: DotTyping, metadata: DotTyping.metadata },
    { id: 'hero-pot', class: HeroPot, metadata: HeroPot.metadata },
    { id: 'kaleidoscope', class: Kaleidoscope, metadata: Kaleidoscope.metadata },
    { id: 'left-to-right', class: LeftToRight, metadata: LeftToRight.metadata },
    { id: 'lissajous-pendulum', class: LissajousPendulum, metadata: LissajousPendulum.metadata },
    { id: 'matrix-code', class: MatrixCode, metadata: MatrixCode.metadata },
    { id: 'migrating-birds', class: MigratingBirds, metadata: MigratingBirds.metadata },
    { id: 'newtons-cradle', class: NewtonsCradle, metadata: NewtonsCradle.metadata },
    { id: 'night-sky', class: NightSky, metadata: NightSky.metadata },
    { id: 'plant-growth', class: PlantGrowth, metadata: PlantGrowth.metadata },
    { id: 'right-to-left', class: RightToLeft, metadata: RightToLeft.metadata },
    { id: 'ripple', class: Ripple, metadata: Ripple.metadata },
    { id: 'sand-clock', class: SandClock, metadata: SandClock.metadata },
