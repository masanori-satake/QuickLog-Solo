...
export const messages = {
    ...
    ja: {
        ...
        'label-mode': '描画モード',
        'label-exclusion-strategy': '遮蔽戦略 (Exclusion Strategy)',
        'strategy-mask': 'マスク (標準)',
        'strategy-pseudo': '疑似空間 (UIを飛び越える)',
        'strategy-ignore': '無視 (全面に描画)',
    ...
    en: {
        ...
        'label-mode': 'Mode',
        'label-exclusion-strategy': 'Exclusion Strategy',
        'strategy-mask': 'Mask (Standard)',
        'strategy-pseudo': 'Pseudo Space (Jump UI)',
        'strategy-ignore': 'Ignore (Draw All)',
    ...
    de: {
        ...
        'label-mode': 'Modus',
        'label-exclusion-strategy': 'Ausschlussstrategie',
        'strategy-mask': 'Maske (Standard)',
        'strategy-pseudo': 'Pseudo-Raum (UI überspringen)',
        'strategy-ignore': 'Ignorieren (Alles zeichnen)',
    ...
    es: {
        ...
        'label-mode': 'Modo',
        'label-exclusion-strategy': 'Estrategia de exclusión',
        'strategy-mask': 'Máscara (Estándar)',
        'strategy-pseudo': 'Pseudoespacio (Saltar UI)',
        'strategy-ignore': 'Ignorar (Dibujar todo)',
    ...
    fr: {
        ...
        'label-description': 'Description',
        'label-mode': 'Mode',
        'label-exclusion-strategy': 'Stratégie d\'exclusion',
        'strategy-mask': 'Masque (Standard)',
        'strategy-pseudo': 'Pseudo-espace (Sauter l\'UI)',
        'strategy-ignore': 'Ignorer (Tout dessiner)',
    ...
    pt: {
        ...
        'label-mode': 'Modo',
        'label-exclusion-strategy': 'Estratégia de exclusão',
        'strategy-mask': 'Máscara (Padrão)',
        'strategy-pseudo': 'Pseudo-espaço (Pular UI)',
        'strategy-ignore': 'Ignorar (Desenhar tudo)',
    ...
    ko: {
        ...
        'label-mode': '모드',
        'label-exclusion-strategy': '제외 전략 (Exclusion Strategy)',
        'strategy-mask': '마스크 (표준)',
        'strategy-pseudo': '의사 공간 (UI 건너뛰기)',
        'strategy-ignore': '무시 (전체 그리기)',
    ...
    zh: {
        ...
        'label-mode': '模式',
        'label-exclusion-strategy': '避让策略 (Exclusion Strategy)',
        'strategy-mask': '掩码 (标准)',
        'strategy-pseudo': '伪空间 (跳过 UI)',
        'strategy-ignore': '忽略 (全屏绘制)',
