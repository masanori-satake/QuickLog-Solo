...
export const messages = {
    ...
    ja: {
        ...
        'label-mode': '描画モード',
        'label-exclusion-strategy': '回避の決断 (Exclusion Strategy)',
        'strategy-mask': '隠されてもいい (Mask)',
        'strategy-jump': 'UIを飛び越える (Jump)',
        'strategy-freedom': '全領域を使い切る (Freedom)',
        'label-rewindable': '巻き戻し可能',
        'rewindable-desc': '過去の時刻での描画に対応',
        ...
        'btn-magic': 'マジック・スニペット (コードを挿入)',
        'snippet-bouncing-star': '跳ねる星',
        'snippet-digital-snow': 'デジタル・スノー',
        'snippet-heartbeat': '鼓動',
        'snippet-wave': 'サイン波',
        'confirm-snippet-overwrite': '現在のコードが上書きされます。よろしいですか？',
        'toast-snippet-inserted': 'スニペットを挿入しました！'
    },
    en: {
        // UI Header & Sections
        'title': 'QuickLog-Solo',
        ...
        'label-mode': 'Mode',
        'label-exclusion-strategy': 'Strategy Decision',
        'strategy-mask': 'Accept Masking (Mask)',
        'strategy-jump': 'Jump over UI (Jump)',
        'strategy-freedom': 'Complete Freedom (Freedom)',
        'label-rewindable': 'Rewindable',
        'rewindable-desc': 'Supports drawing past frames',
        ...
        'btn-magic': 'Magic Snippets (Insert code)',
        'snippet-bouncing-star': 'Bouncing Star',
        'snippet-digital-snow': 'Digital Snow',
        'snippet-heartbeat': 'Heartbeat',
        'snippet-wave': 'Sine Wave',
        'confirm-snippet-overwrite': 'Current code will be overwritten. Are you sure?',
        'toast-snippet-inserted': 'Snippet inserted!'
    },
    de: {
        'title': 'QuickLog-Solo',
        ...
        'label-mode': 'Modus',
        'label-exclusion-strategy': 'Strategie-Entscheidung',
        'strategy-mask': 'Maskierung akzeptieren (Mask)',
        'strategy-jump': 'UI überspringen (Jump)',
        'strategy-freedom': 'Vollständige Freiheit (Freedom)',
        'label-rewindable': 'Rückspulbar',
        'rewindable-desc': 'Unterstützt das Zeichnen vergangener Frames',
        ...
        'btn-magic': 'Magische Snippets (Code einfügen)',
        'snippet-bouncing-star': 'Hüpfender Stern',
        'snippet-digital-snow': 'Digitaler Schnee',
        'snippet-heartbeat': 'Herzschlag',
        'snippet-wave': 'Sinuswelle',
        'confirm-snippet-overwrite': 'Der aktuelle Code wird überschrieben. Sind Sie sicher?',
        'toast-snippet-inserted': 'Snippet eingefügt!'
    },
    es: {
        'title': 'QuickLog-Solo',
        ...
        'label-mode': 'Modo',
        'label-exclusion-strategy': 'Decisión de Estrategia',
        'strategy-mask': 'Aceptar Máscara (Mask)',
        'strategy-jump': 'Saltar la UI (Jump)',
        'strategy-freedom': 'Libertad Total (Freedom)',
        'label-rewindable': 'Rebobinable',
        'rewindable-desc': 'Soporta el dibujo de fotogramas pasados',
        ...
        'btn-magic': 'Fragmentos mágicos (Insertar código)',
        'snippet-bouncing-star': 'Estrella saltarina',
        'snippet-digital-snow': 'Nieve digital',
        'snippet-heartbeat': 'Latido',
        'snippet-wave': 'Onda senoidal',
        'confirm-snippet-overwrite': 'El código actual será sobrescrito. ¿Está seguro?',
        'toast-snippet-inserted': '¡Fragmento insertado!'
    },
    fr: {
        'title': 'QuickLog-Solo',
        ...
        'label-description': 'Description',
        'label-mode': 'Mode',
        'label-exclusion-strategy': 'Décision de Stratégie',
        'strategy-mask': 'Accepter le Masque (Mask)',
        'strategy-jump': 'Sauter l\'UI (Jump)',
        'strategy-freedom': 'Liberté Totale (Freedom)',
        'label-rewindable': 'Rembobinable',
        'rewindable-desc': 'Prend en charge le dessin de cadres passés',
        ...
        'btn-magic': 'Extraits magiques (Insérer le code)',
        'snippet-bouncing-star': 'Étoile bondissante',
        'snippet-digital-snow': 'Neige numérique',
        'snippet-heartbeat': 'Battement de coeur',
        'snippet-wave': 'Onde sinusoïdale',
        'confirm-snippet-overwrite': 'Le code actuel sera écrasé. Êtes-vous sûr ?',
        'toast-snippet-inserted': 'Extrait inséré !'
    },
    pt: {
        'title': 'QuickLog-Solo',
        ...
        'label-mode': 'Modo',
        'label-exclusion-strategy': 'Decisão de Estratégia',
        'strategy-mask': 'Aceitar Máscara (Mask)',
        'strategy-jump': 'Pular a UI (Jump)',
        'strategy-freedom': 'Liberdade Total (Freedom)',
        'label-rewindable': 'Rebobinável',
        'rewindable-desc': 'Suporta o desenho de quadros passados',
        'label-show-metrics': 'Mostrar métricas',
        ...
        'btn-magic': 'Snippets mágicos (Inserir código)',
        'snippet-bouncing-star': 'Estrela saltitante',
        'snippet-digital-snow': 'Neve digital',
        'snippet-heartbeat': 'Batimento cardíaco',
        'snippet-wave': 'Onda senoidal',
        'confirm-snippet-overwrite': 'O código atual será sobrescrito. Tem certeza?',
        'toast-snippet-inserted': 'Snippet inserido!'
    },
    ko: {
        'title': 'QuickLog-Solo',
        ...
        'label-mode': '모드',
        'label-exclusion-strategy': '전략 결정 (Exclusion Strategy)',
        'strategy-mask': '가려짐 수용 (Mask)',
        'strategy-jump': 'UI 뛰어넘기 (Jump)',
        'strategy-freedom': '자유로운 공간 활용 (Freedom)',
        'label-rewindable': '되감기 가능',
        'rewindable-desc': '과거 프레임 그리기 지원',
        ...
        'btn-magic': '매직 스니펫 (코드 삽입)',
        'snippet-bouncing-star': '튀는 별',
        'snippet-digital-snow': '디지털 눈',
        'snippet-heartbeat': '심장 박동',
        'snippet-wave': '사인파',
        'confirm-snippet-overwrite': '현재 코드가 덮어씌워집니다. 계속하시겠습니까?',
        'toast-snippet-inserted': '스니펫이 삽입되었습니다!'
    },
    zh: {
        'title': 'QuickLog-Solo',
        ...
        'label-mode': '模式',
        'label-exclusion-strategy': '策略决策 (Exclusion Strategy)',
        'strategy-mask': '接受掩码 (Mask)',
        'strategy-jump': '跳过 UI (Jump)',
        'strategy-freedom': '全屏自由 (Freedom)',
        'label-rewindable': '可倒带',
        'rewindable-desc': '支持绘制过去的帧',
        ...
        'btn-magic': '魔术代码片段 (插入代码)',
        'snippet-bouncing-star': '跳动的星',
        'snippet-digital-snow': '数字雪花',
        'snippet-heartbeat': '心跳',
        'snippet-wave': '正弦波',
        'confirm-snippet-overwrite': '当前代码将被覆盖。您确定吗？',
        'toast-snippet-inserted': '片段已插入！'
    }
};
