...
export const messages = {
    ...
    ja: {
        ...
        'about-description': 'QuickLog-Solo は、プライバシー重視のミニマリストな作業メモツールです。データはブラウザ内の IndexedDB に保存され（バックアップ機能を有効化した際にはローカルファイルシステムにも保存されます）、外部送信は一切行われません。外部ライブラリを使用しない軽量・セキュアな設計で、サイドパネルからいつでも素早く記録できます。',
        ...
        // Backup Tab
        'setting-backup-enable': 'ローカルバックアップ',
        'setting-backup-interval': '同期頻度',
        'interval-immediate': '即時 (安全性重視)',
        'interval-5m': '5分毎 (バランス)',
        'interval-1h': '1時間毎 (負荷低減)',
    ...
    en: {
        ...
        // Backup Tab
        'setting-backup-enable': 'Local File Backup',
        'setting-backup-interval': 'Sync Interval',
        'interval-immediate': 'Immediate (Safety)',
        'interval-5m': '5 min (Balanced)',
        'interval-1h': '1 hour (Low Load)',
        ...
        'btn-select-directory': 'Select Directory',
    ...
    de: {
        ...
        'about-description': 'QuickLog-Solo ist ein datenschutzorientiertes minimalistisches Arbeitsnotiz-Tool. Die Daten werden in der IndexedDB Ihres Browsers gespeichert (bei aktivierter Backup-Funktion auch im lokalen Dateisystem) und niemals extern übertragen. Es zeichnet sich durch ein leichtgewichtiges, sicheres Design ohne externe Bibliotheken aus und ermöglicht so jederzeit schnelle Aufzeichnungen über die Seitenleiste.',
        ...
        'setting-backup-enable': 'Lokale Dateisicherung',
        'setting-backup-interval': 'Sync-Intervall',
        'interval-immediate': 'Sofort (Sicherheit)',
        'interval-5m': '5 Min. (Ausgewogen)',
        'interval-1h': '1 Std. (Niedrige Last)',
        'backup-status-label': 'Aktueller Status',
        'backup-status-synced': 'Synchronisiert',
        'backup-status-syncing': 'Synchronisierung...',
        'backup-status-dirty': 'Nicht gespeicherte Änderungen',
        'backup-status-failed': 'Fehlgeschlagen',
        'backup-last-time': 'Letzte Synchronisierung',
        'backup-directory': 'Verzeichnis',
        'backup-file-count': 'Dateianzahl',
        'backup-file-count-unit': 'Tage',
        'btn-select-directory': 'Verzeichnis wählen',
        'backup-description': 'Speichert täglich Dateien in einem lokalen Ordner zum Schutz vor Browser-Cache-Löschung. Die Richtlinie „Daten älter als 40 Tage löschen“ gilt auch hier.',
        'backup-permission-request': 'Um die Sicherung nach einem Neustart fortzusetzen, müssen Sie den Zugriff erneut gewähren.',
        'btn-grant-permission': 'Zugriff erlauben',
        'btn-sync-now': 'Jetzt synchronisieren',
        'tooltip-backup-status': 'Sicherungsstatus',
        'toast-backup-enabled': 'Sicherung aktiviert. Verlauf wird synchronisiert...',
        'toast-backup-disabled': 'Sicherung deaktiviert.',
    ...
    es: {
        ...
        'about-description': 'QuickLog-Solo es una herramienta de notas de trabajo minimalista centrada en la privacidad. Los datos se guardan en IndexedDB dentro de su navegador (y también en el sistema de archivos local cuando se activa la función de respaldo) y nunca se envían al exterior. Cuenta con un diseño ligero y seguro, sin librerías externas, lo que permite realizar registros rápidos en cualquier momento desde la barra lateral.',
        ...
        'setting-backup-enable': 'Respaldo en archivos locales',
        'setting-backup-interval': 'Intervalo de sincronización',
        'interval-immediate': 'Inmediato (Seguridad)',
        'interval-5m': '5 min (Equilibrado)',
        'interval-1h': '1 h (Carga baja)',
        'backup-status-label': 'Estado actual',
        'backup-status-synced': 'Sincronizado',
        'backup-status-syncing': 'Sincronizando...',
        'backup-status-dirty': 'Cambios sin guardar',
        'backup-status-failed': 'Error de sincronización',
        'backup-last-time': 'Última sincronización',
        'backup-directory': 'Directorio',
        'backup-file-count': 'Archivos',
        'backup-file-count-unit': 'días',
        'btn-select-directory': 'Seleccionar directorio',
        'backup-description': 'Guarda archivos diarios en una carpeta local para proteger contra la limpieza de caché del navegador. La política de borrar registros de más de 40 días también se aplica aquí.',
        'backup-permission-request': 'Para continuar el respaldo tras reiniciar el navegador, debe otorgar acceso a la carpeta nuevamente.',
        'btn-grant-permission': 'Permitir acceso',
        'btn-sync-now': 'Sincronizar ahora',
        'tooltip-backup-status': 'Estado de respaldo',
        'toast-backup-enabled': 'Respaldo activado. Sincronizando historial...',
        'toast-backup-disabled': 'Respaldo desactivado.',
    ...
    fr: {
        ...
        'about-description': 'QuickLog-Solo est un outil de notes de travail minimaliste axé sur la confidentialité. Les données sont enregistrées dans IndexedDB sur votre navigateur (et également sur le système de fichiers local lorsque la fonction de sauvegarde est activée) et ne sont jamais envoyées à l\'extérieur. Il présente une conception légère et sécurisée, sans bibliothèques externes, permettant un enregistrement rapide à tout moment depuis le panneau latéral.',
        ...
        'setting-backup-enable': 'Sauvegarde sur fichiers locaux',
        'setting-backup-interval': 'Intervalle de synchronisation',
        'interval-immediate': 'Immédiat (Sécurité)',
        'interval-5m': '5 min (Équilibré)',
        'interval-1h': '1 h (Charge faible)',
        'backup-status-label': 'Statut actuel',
        'backup-status-synced': 'Synchronisé',
        'backup-status-syncing': 'Synchronisation...',
        'backup-status-dirty': 'Modifications non enregistrées',
        'backup-status-failed': 'Échec de synchro',
        'backup-last-time': 'Dernière synchronisation',
        'backup-directory': 'Répertoire',
        'backup-file-count': 'Fichiers',
        'backup-file-count-unit': 'jours',
        'btn-select-directory': 'Choisir un répertoire',
        'backup-description': 'Enregistre quotidiennement des fichiers dans un dossier local pour vous protéger contre l\'effacement du cache du navigateur. La règle de suppression des données de plus de 40 jours s\'applique aussi ici.',
        'backup-permission-request': 'Pour continuer la sauvegarde après un redémarrage, vous devez redonner l\'accès au dossier.',
        'btn-grant-permission': 'Autoriser l\'accès',
        'btn-sync-now': 'Synchroniser maintenant',
        'tooltip-backup-status': 'État de la sauvegarde',
        'toast-backup-enabled': 'Sauvegarde activée. Synchronisation en cours...',
        'toast-backup-disabled': 'Sauvegarde désactivée.',
    ...
    pt: {
        ...
        'setting-backup-enable': 'Backup em arquivos locais',
        'setting-backup-interval': 'Intervalo de sincronização',
        'interval-immediate': 'Imediato (Segurança)',
        'interval-5m': '5 min (Equilibrado)',
        'interval-1h': '1 h (Carga baixa)',
        'backup-status-label': 'Status atual',
        'backup-status-synced': 'Sincronizado',
        'backup-status-syncing': 'Sincronizando...',
        'backup-status-dirty': 'Alterações não salvas',
        'backup-status-failed': 'Falha na sincronização',
        'backup-last-time': 'Última sincronização',
        'backup-directory': 'Diretório',
        'backup-file-count': 'Arquivos',
        'backup-file-count-unit': 'dias',
        'btn-select-directory': 'Selecionar diretório',
        'backup-description': 'Salva arquivos diários em uma pasta local para proteger contra a limpeza do cache do navegador. A política de exclusão de registros com mais de 40 dias também se aplica aqui.',
        'backup-permission-request': 'Para continuar o backup após reiniciar o navegador, você precisa conceder acesso à pasta novamente.',
        'btn-grant-permission': 'Permitir acesso',
        'btn-sync-now': 'Sincronizar agora',
        'tooltip-backup-status': 'Status do backup',
        'toast-backup-enabled': 'Backup ativado. Sincronizando histórico...',
        'toast-backup-disabled': 'Backup desativado.',
    ...
    ko: {
        ...
        'about-description': 'QuickLog-Solo는 개인정보를 중시하는 미니멀리스트 작업 메모 도구입니다. 데이터는 브라우저의 IndexedDB에 저장되며(백업 기능을 활성화했을 때는 로컬 파일 시스템에도 저장됩니다) 외부로 전송되지 않습니다. 외부 라이브러리를 사용하지 않는 가볍고 안전한 설계로, 사이드 패널에서 언제든지 신속하게 기록할 수 있습니다.',
        ...
        'setting-backup-enable': '로컬 파일 백업',
        'setting-backup-interval': '동기화 간격',
        'interval-immediate': '즉시 (안전성 우선)',
        'interval-5m': '5분마다 (밸런스)',
        'interval-1h': '1시간마다 (부하 저감)',
        'backup-status-label': '현재 상태',
        'backup-status-synced': '동기화됨',
        'backup-status-syncing': '동기화 중...',
        'backup-status-dirty': '저장되지 않은 변경 사항',
        'backup-status-failed': '동기화 실패',
        'backup-last-time': '마지막 동기화',
        'backup-directory': '저장 경로',
        'backup-file-count': '파일 수',
        'backup-file-count-unit': '일분',
        'btn-select-directory': '폴더 선택',
        'backup-description': '브라우저 캐시 삭제에 대비하여 지정된 로컬 폴더에 날짜별 파일을 자동으로 저장합니다. 40일 이전 기록 삭제 정책도 동일하게 적용됩니다.',
        'backup-permission-request': '브라우저 재시작 후 백업을 계속하려면 폴더 액세스 권한을 다시 허용해야 합니다.',
        'btn-grant-permission': '권한 허용',
        'btn-sync-now': '지금 동기화',
        'tooltip-backup-status': '백업 상태',
        'toast-backup-enabled': '백업이 활성화되었습니다. 이력을 동기화하는 중...',
        'toast-backup-disabled': '백업이 비활성화되었습니다.',
    ...
    zh: {
        ...
        'about-description': 'QuickLog-Solo 是一款注重隐私的极简工作笔记工具。数据保存在您浏览器的 IndexedDB 中（启用备份功能时也会保存到本地文件系统），且绝不上传服务器。它采用不使用外部库的轻量级、安全设计，可随时通过侧边栏快速记录。',
        ...
        'setting-backup-enable': '本地文件备份',
        'setting-backup-interval': '同步频率',
        'interval-immediate': '实时 (安全优先)',
        'interval-5m': '每 5 分钟 (平衡)',
        'interval-1h': '每 1 小时 (低负载)',
        'backup-status-label': '当前状态',
        'backup-status-synced': '已同步',
        'backup-status-syncing': '同步中...',
        'backup-status-dirty': '未保存的更改',
        'backup-status-failed': '同步失败',
        'backup-last-time': '最近同步时刻',
        'backup-directory': '保存目录',
        'backup-file-count': '文件数量',
        'backup-file-count-unit': '天',
        'btn-select-directory': '选择目录',
        'backup-description': '自动将每日文件保存到本地文件夹，以防止浏览器缓存清理导致数据丢失。应用“删除 40 天前记录”的策略同样适用。',
        'backup-permission-request': '重启浏览器后如需继续备份，需要重新授予文件夹访问权限。',
        'btn-grant-permission': '授予权限',
        'btn-sync-now': '立即同步',
        'tooltip-backup-status': '备份状态',
        'toast-backup-enabled': '备份已启用。正在同步历史记录...',
        'toast-backup-disabled': '备份已禁用。',
