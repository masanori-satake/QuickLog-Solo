...
export const messages = {
    ...
    de: {
        ...
        'about-description': 'QuickLog-Solo ist ein datenschutzorientiertes minimalistisches Arbeitsnotiz-Tool. Die Daten werden in der IndexedDB Ihres Browsers gespeichert (bei aktivierter Backup-Funktion auch im lokalen Dateisystem) und niemals extern übertragen.',
    ...
    es: {
        ...
        'about-description': 'QuickLog-Solo es una herramienta de notas de trabajo minimalista centrada en la privacidad. Los datos se guardan en IndexedDB dentro de su navegador (y también en el sistema de archivos local cuando se activa la función de respaldo).',
    ...
    fr: {
        ...
        'about-description': 'QuickLog-Solo est un outil de notes de travail minimaliste axé sur la confidentialité. Les données sont enregistrées dans IndexedDB sur votre navigateur (et également sur le système de fichiers local lorsque la fonction de sauvegarde est activée).',
    ...
    pt: {
        ...
        'about-description': 'O QuickLog-Solo é uma ferramenta de notas de trabalho minimalista focada na privacidade. Os dados são salvos no IndexedDB do seu navegador (e também no sistema de arquivos local quando a função de backup estiver ativada).',
    ...
    ko: {
        ...
        'about-description': 'QuickLog-Solo는 개인정보를 중시하는 미니멀리스트 작업 메모 도구입니다. 데이터는 브라우저의 IndexedDB에 저장되며(백업 기능을 활성화했을 때는 로컬 파일 시스템에도 저장됩니다) 외부로 전송되지 않습니다.',
    ...
    zh: {
        ...
        'about-description': 'QuickLog-Solo 是一款注重隐私的极简工作笔记工具。数据保存在您浏览器的 IndexedDB 中（启用备份功能时也会保存到本地文件系统）。',
