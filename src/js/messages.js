...
export const messages = {
    ...
    ja: {
        ...
        'label-ignore-exclusion': '回避エリアを無視',
        'ignore-exclusion-desc': '技術的な表示（テストパターン等）向け',
    ...
    en: {
        ...
        'label-ignore-exclusion': 'Ignore Exclusion',
        'ignore-exclusion-desc': 'For technical modules (e.g. Test Pattern)',
    ...
    de: {
        ...
        'label-ignore-exclusion': 'Ausschlüsse ignorieren',
        'ignore-exclusion-desc': 'Für technische Module (z.B. Testmuster)',
    ...
    es: {
        ...
        'label-ignore-exclusion': 'Ignorar exclusión',
        'ignore-exclusion-desc': 'Para módulos técnicos (ej. patrón de prueba)',
    ...
    fr: {
        ...
        'label-ignore-exclusion': 'Ignorer l\'exclusion',
        'ignore-exclusion-desc': 'Pour les modules techniques (ex. mire)',
    ...
    pt: {
        ...
        'label-ignore-exclusion': 'Ignorar exclusão',
        'ignore-exclusion-desc': 'Para módulos técnicos (ex: padrão de teste)',
        'label-show-metrics': 'Mostrar métricas',
    ...
    ko: {
        ...
        'label-ignore-exclusion': '제외 영역 무시',
        'ignore-exclusion-desc': '기술 모듈용(예: 테스트 패턴)',
    ...
    zh: {
        ...
        'label-ignore-exclusion': '忽略避让区域',
        'ignore-exclusion-desc': '用于技术模块（如测试图卡）',
