...
test.describe('Theme switching', () => {
    ...
    test('should apply dark theme correctly and have good contrast', async ({ page }) => {
        ...
        await expect(pauseBtn).toHaveCSS(
            'background-color',
            /(rgb\(64, 70, 89\)|rgba\(64, 70, 89, 0\.6\)|color\(srgb 0\.25098\d* 0\.27451\d* 0\.34902\d* \/ 0\.6\))/
        );
        ...
        await expect(endBtn).toHaveCSS(
            'background-color',
            /(rgb\(147, 0, 10\)|rgba\(147, 0, 10, 0\.6\)|color\(srgb 0\.57647\d* 0 0\.03921\d* \/ 0\.6\))/
        );
