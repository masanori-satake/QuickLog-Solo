export default {
    ...
    'setting-category-layout': 'カテゴリボタンのレイアウト',
    'category-layout-2x8': '2列 x 8段',
    'category-layout-2x4': '2列 x 4段',
    'setting-animation-default': 'Animação de fundo padrão',
    'setting-pause-animation': '待機中背景アニメーション',
    'setting-pause-theme': '待機中テーマ',
    ...
    'tooltip-category-layout-select': 'カテゴリボタンのレイアウトを選択します',
    'tooltip-animation-select': 'Selecionar animação de fundo global',
    'tooltip-pause-animation-select': '待機中の背景アニメーションを選択します',
    'tooltip-pause-theme-select': '待機中のテーマカラーを選択します',
