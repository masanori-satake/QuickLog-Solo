export default {
    ...
    'btn-add-category': 'Añadir categoría',
    'btn-add-custom-anim': 'Añadir animación personalizada',
    ...
    'tooltip-font-weight-select': 'Seleccionar grosor de fuente',
    'tooltip-category-layout-select': 'Seleccionar diseño de botones de categoría',
    'tooltip-animation-select': 'Seleccionar animación de fondo global',
    'tooltip-pause-animation-select': 'Seleccionar animación de fondo en espera',
    'tooltip-pause-theme-select': 'Seleccionar color de tema en espera',
    ...
    'setting-font': 'Fuente',
    'setting-font-weight': 'Grosor de fuente',
    'font-weight-normal': 'Estándar',
    'font-weight-medium': 'Medio',
    'font-weight-bold': 'Negrita',
    'font-weight-heavy': 'Extra negrita',
    'setting-category-layout': 'Diseño de botones de categoría',
    'category-layout-2x8': '2 cols. x 8 filas',
    'category-layout-2x4': '2 cols. x 4 filas',
    'setting-animation-default': 'Animación de fondo estándar',
    'setting-pause-animation': 'Animación de fondo en espera',
    'setting-pause-theme': 'Tema en espera',
    ...
    'maintenance-sync-clear-cloud': 'Eliminar historial de todos los dispositivos',
    'btn-sync-clear-cloud': 'Eliminar todo el historial de todos los dispositivos sincronizados',
    ...
    'btn-initialize-all': 'Inicializar todo',
    ...
    'backup-not-selected': '(No seleccionado)',
    ...
    'confirm-discard-changes': 'Los cambios no se han guardado. ¿Desea descartar los cambios y cerrar?',
    ...
    'sync-setup-local-to-cloud': 'Sobrescribir otros dispositivos con datos locales',
    'sync-setup-merge': 'Combinar historial local con otros dispositivos',
    ...
    'tab-custom-anim': 'Animaciones personalizadas',
    'custom-anim-select-label': 'Animaciones personalizadas registradas',
    'custom-anim-import': 'Importar (Añadir nueva)',
    'btn-add-from-file': 'Añadir desde archivo',
    'btn-add-from-clipboard': 'Añadir desde el portapapeles',
    'custom-anim-export': 'Exportar',
    'btn-save-to-file': 'Guardar en archivo',
    'btn-copy-to-clipboard': 'Copiar al portapapeles',
    'custom-anim-delete-label': 'Eliminar',
    ...
    'maker-brightness': 'Brillo',
    'maker-gif-import': 'Importar imagen GIF',
    'maker-drop-hint': 'Suelta un GIF animado aquí o haz clic para seleccionarlo',
    'maker-file-name': 'Archivo:',
    'maker-dimensions': 'Dimensiones:',
    'maker-frames-count': 'Fotogramas:',
    'maker-spec-monitor': 'Especificaciones en vivo',
    'maker-current-scale': 'Escala actual',
    'maker-target-height': 'targetHeight',
    'maker-boundary-height': 'Altura de la línea de ayuda (guía)',
    'maker-drag-instruction': 'Arrastre la imagen para ajustar la posición',
    'maker-zoom-in': 'Ampliar',
    'maker-zoom-out': 'Reducir',
    ...
    'qr-scan-unsupported': 'Este navegador no admite el escaneo de códigos QR. Utilice un navegador compatible.',
