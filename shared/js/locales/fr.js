export default {
    ...
    'maintenance-sync-pull': 'Récupérer l\'historique de travail depuis la session',
    'btn-sync-pull': 'Initialiser avec les informations de la session',
    'maintenance-sync-clear-cloud': 'Supprimer l\'historique de travail de la session',
    'btn-sync-clear-cloud': 'Supprimer tout l\'historique de travail de la session',
    ...
    'confirm-sync-pull': 'L\'historique de travail local sera supprimé et récupéré à partir des informations de la session. La tâche actuelle sera terminée. Continuer ?',
    'confirm-sync-clear-cloud': 'Tout l\'historique de travail de la session et local sera supprimé. La tâche actuelle sera terminée. Continuer ?',
    ...
    'setting-session-sync': 'Synchronisation de session (Sync) (β)',
    'setting-session-sync-desc': 'Synchronisez en toute sécurité les paramètres, les categories et l\'historique récent à l\'aide de la fonction de synchronisation de session de votre navigateur.',
    ...
    'confirm-enable-session-sync': 'Activer la synchronisation de session ? Vos données actuelles seront téléchargées sur le stockage cloud de votre navigateur.',
