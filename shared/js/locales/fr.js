export default {
    ...
    'maker-note-extension-only':
        "* QL-Animation Maker est uniquement disponible lorsqu'il est installé en tant qu'extension de navigateur. Il ne peut pas être lancé dans la version de prévisualisation.",
