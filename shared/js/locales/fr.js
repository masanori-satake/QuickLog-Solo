export default {
    ...
    'setting-session-sync': 'Synchronisation de session (Sync)',
    'setting-session-sync-desc': 'Synchronisez en toute sécurité les paramètres, les categories et l\'historique récent à l\'aide de la fonction de synchronisation de session de votre navigateur. Utile pour travailler sur plusieurs appareils.',
