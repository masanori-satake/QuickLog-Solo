export default {
    ...
    'confirm-delete-custom-anim': 'Voulez-vous supprimer l\'animation personnalisée "{name}" ?\n(Les catégories attribuées à cette animation seront réinitialisées à "Aucune")',
    ...
    'maker-drop-hint': 'Glissez et déposez le fichier GIF ici, ou cliquez pour le sélectionner',
    ...
    'maker-note-extension-only': '* Le créateur d\'animations est uniquement disponible lorsqu\'il est installé en tant qu\'extension de navigateur. Il ne peut pas être lancé dans la version de prévisualisation.',
    'maker-error-name-empty': 'Le nom ne peut pas être vide',
    'maker-error-name-duplicate': 'Une animation personnalisée portant le même nom existe déjà. Veuillez entrer un nom différent.',
