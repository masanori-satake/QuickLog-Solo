export default {
    ...
    'tooltip-category-layout-select': 'Choisir la disposition des boutons de catégorie',
    'tooltip-animation-select': "Choisir l'animation de fond globale",
    'tooltip-pause-animation-select': "Choisir l'animation de fond en attente",
    'tooltip-pause-theme-select': "Choisir la couleur de thème en attente",
    ...
    'alarm-tooltip-confirmation':
        'Maintenir la notification jusqu\u0027à ce que OK soit cliqué, puis exécuter l\u0027action',
    ...
    'setting-category-layout': 'Disposition des boutons de catégorie',
    'category-layout-2x8': '2 col. x 8 lignes',
    'category-layout-2x4': '2 col. x 4 lignes',
    'setting-animation-default': 'Animation de fond standard',
    'setting-pause-animation': 'Animation de fond en attente',
    'setting-pause-theme': 'Thème en attente',
    ...
    'backup-execute': 'Sauvegarde',
    'backup-change-dir': 'Changer la destination',
    ...
    'confirm-restore-desc':
        'Toutes les données actuelles seront supprimées et remplacées par les données de sauvegarde. Cette action est irréversible.',
    ...
    'restore-error-write-failed':
        'Une erreur est survenue pendant la restauration. Les données peuvent être dans un état incomplet.',
    ...
    'confirm-delete-initialize':
        'Les données suivantes seront supprimées/initialisées :\n{items}\n\nCette action est irréversible. Êtes-vous sûr ?',
    ...
    'confirm-discard-changes':
        'Les modifications ne sont pas enregistrées. Voulez-vous annuler les modifications et fermer ?',
    ...
    'confirm-sync-pull':
        "L'historique de travail local sera supprimé et récupéré à partir d'autres appareils. La tâche actuelle sera terminée. Continuer ?",
    'confirm-sync-clear-cloud':
        "L'historique de travail sera supprimé de tous les appareils synchronisés, pas seulement de celui-ci. La tâche actuelle sera terminée. Continuer ?",
    'confirm-reset-all':
        "Les catégories et paramètres seront réinitialisés. Continuer ? (L'historique de travail sera conservé)",
    'confirm-reset-settings':
        "Les paramètres seront réinitialisés. Continuer ? (L'historique de travail et les catégories seront conservés)",
    ...
    'toast-done-with-reopen-msg':
        'Appliqué avec succès ! Si le panneau des paramètres est ouvert, veuillez le fermer et le rouvrir pour appliquer la nouvelle animation.',
    ...
    'setting-session-sync-desc':
        "Synchronisez les paramètres, les catégories et l'historique récent entre les appareils à l'aide de la synchronisation du navigateur.",
    'setting-session-sync-note':
        "* Remarque : La synchronisation entre différents navigateurs (par exemple, Chrome et Edge) n'est pas prise en charge.",
    'confirm-enable-session-sync':
        'Activer la synchronisation entre appareils ? Vos données actuelles seront téléchargées sur le stockage cloud de votre navigateur.',
    'confirm-disable-session-sync':
        "Désactiver la synchronisation entre appareils ? Cet appareil ne sera plus synchronisé, mais les données partagées avec d'autres appareils seront conservées.",
    ...
    'sync-setup-desc':
        "Pour démarrer la synchronisation, veuillez choisir la priorité entre les données existantes et les données d'autres appareils.",
    ...
    'tab-custom-anim': 'Animations personnalisées',
    'custom-anim-select-label': 'Animations personnalisées enregistrées',
    'custom-anim-import': 'Importer (Ajouter)',
    'btn-add-from-file': "Ajouter à partir d'un fichier",
    'btn-add-from-clipboard': 'Ajouter à partir du presse-papiers',
    'custom-anim-export': 'Exporter',
    'btn-save-to-file': 'Enregistrer dans un fichier',
    'btn-copy-to-clipboard': 'Copier dans le presse-papiers',
    'custom-anim-delete-label': 'Supprimer',
    'btn-delete-selected-anim': "Supprimer l'animation sélectionnée",
    'toast-custom-anim-imported': 'Animation personnalisée importée avec succès',
    'toast-custom-anim-exported': 'Animation personnalisée copiée dans le presse-papiers',
    'confirm-delete-custom-anim':
        'Voulez-vous supprimer l\'animation personnalisée "{name}" ?\n(Les catégories attribuées à cette animation seront réinitialisées à "Aucune")',
    'alert-invalid-qlanim': 'Format .qlanim invalide. Veuillez vérifier la structure du fichier.',
    'btn-launch-maker': "Lancer le créateur d'animations",
    'maker-title': "Créateur d'animations",
    'placeholder-meta-name': 'Mon Animation',
    'placeholder-meta-author': 'Votre Nom',
    'placeholder-meta-desc': 'Brève explication de votre animation',
    'maker-overflow-behavior': 'Mosaïque horizontale',
    'maker-max-width': 'Largeur maximale (maxWidth)',
    'maker-scale-with-height': "Mettre à l'échelle avec la hauteur",
    'maker-invert': 'Inverser (Négatif/Positif)',
    'maker-brightness': 'Luminosité',
    'maker-gif-import': 'Importer une image GIF',
    'maker-drop-hint': 'Déposez un GIF animé ici ou cliquez pour le sélectionner',
    'maker-file-name': 'Fichier :',
    'maker-dimensions': 'Dimensions :',
    'maker-frames-count': 'Images :',
    'maker-spec-monitor': 'Spécifications en direct',
    ...
    'maker-playback-zoom': 'Lecture et Zoom',
    'maker-data-transfer': 'Transfert de données',
    'maker-warning-title': 'Avertissement',
    'maker-note-extension-only':
        "* Le créateur d'animations est uniquement disponible lorsqu'il est installé en tant qu'extension de navigateur. Il ne peut pas être lancé dans la version de prévisualisation.",
    'maker-error-name-empty': 'Le nom ne peut pas être vide',
    ...
    'qr-scan-unsupported': 'Ce navigateur ne prend pas en charge la lecture des codes QR. Veuillez utiliser un navigateur compatible.',
