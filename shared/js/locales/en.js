export default {
    ...
    'maintenance-sync-pull': 'Re-pull Work History from Session',
    'btn-sync-pull': 'Initialize with Session Information',
    'maintenance-sync-clear-cloud': 'Delete Work History from Session',
    'btn-sync-clear-cloud': 'Delete All Work History from Session',
    ...
    'confirm-sync-pull': 'Local work history will be deleted and re-acquired from session information. Any active task will be ended. Proceed?',
    'confirm-sync-clear-cloud': 'All work history on both session and local will be deleted. Any active task will be ended. Proceed?',
    ...
    'setting-session-sync': 'Session Linkage (Sync) (β)',
    'setting-session-sync-desc': 'Securely synchronize settings, categories, and recent history using browser sessions.',
