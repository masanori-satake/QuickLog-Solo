export default {
    ...
    'confirm-sync-pull': 'ローカルの作業履歴を削除し、セッション上の情報で再取得します。実行中の作業がある場合は終了されます。よろしいですか？',
    'confirm-sync-clear-cloud': 'セッション上とローカルの全ての作業履歴を削除します。実行中の作業がある場合は終了されます。よろしいですか？',
    ...
    'setting-session-sync-desc': 'ブラウザのセッション機能を利用して、設定・カテゴリ・直近の履歴をセキュアに同期します。',
