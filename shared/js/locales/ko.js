export default {
    ...
    'maintenance-sync-pull': '세션 정보로부터 작업 기록 다시 로딩',
    'btn-sync-pull': '세션 정보로 초기화',
    'maintenance-sync-clear-cloud': '세션 정보의 작업 기록 삭제',
    'btn-sync-clear-cloud': '세션 정보의 작업 기록 전부 삭제',
    ...
    'confirm-sync-pull':
        '로컬 작업 기록을 삭제하고, 세션상의 정보로 다시 로딩합니다. 진행 중인 작업은 종료됩니다. 계속하시겠습니까?',
    'confirm-sync-clear-cloud':
        '세션상과 로컬의 모든 작업 기록을 삭제합니다. 진행 중인 작업은 종료됩니다. 계속하시겠습니까?',
    ...
    'confirm-disable-session-sync':
        '세션 연결을 비활성화하시겠습니까? 이 단말기에서의 동기화는 정지됩니다만, 클라우드상의 데이터는 유지됩니다.',
    'session-sync-active': '세션 연결중',
    'local-only-active': '로컬 완결',
    'sync-setup-title': '세션 연결 설정',
    'sync-setup-desc': '연결을 시작하기에 앞서, 기존 데이터와 세션상의 데이터의 우선순위를 선택해 주십시오.',
    'sync-setup-settings-title': '설정 및 카테고리 동기화',
    'sync-setup-history-title': '기록 동기화',
    'sync-setup-cloud-to-local': '세션상의 정보로 덮어쓰기',
    'sync-setup-local-to-cloud': '이 단말기의 정보로 세션 덮어쓰기',
    'sync-setup-merge': '세션상의 정보에 이 단말기의 기록을 병합하기',
};
