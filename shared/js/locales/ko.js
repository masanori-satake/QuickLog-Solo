export default {
    ...
    'maintenance-sync-pull': '세션 정보에서 작업 이력 다시 가져오기',
    'btn-sync-pull': '세션 정보로 초기화',
    'maintenance-sync-clear-cloud': '세션 정보의 작업 이력 삭제',
    'btn-sync-clear-cloud': '세션 정보의 모든 작업 이력 삭제',
    ...
    'confirm-sync-pull': '로컬 작업 이력을 삭제하고 세션 정보에서 다시 가져옵니다. 진행 중인 작업은 종료됩니다. 계속하시겠습니까?',
    'confirm-sync-clear-cloud': '세션 및 로컬의 모든 작업 이력을 삭제합니다. 진행 중인 작업은 종료됩니다. 계속하시겠습니까?',
    ...
    'setting-session-sync': '세션 연동 (Sync) (β)',
    'setting-session-sync-desc': '브라우저 세션 기능을 이용하여 설정, 카테고리, 최근 이력을 안전하게 동기화합니다.',
