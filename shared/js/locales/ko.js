export default {
    ...
    'alarm-editor-title': '알람 편집기',
    'btn-launch-alarm-editor': '편집',
    'alarm-label-type': '실행 타이밍',
    'alarm-type-daily': '매일',
    'alarm-type-daily_business': '매일(근무일만)',
    'alarm-type-weekly': '요일 지정',
    'alarm-type-monthly_date': '매월 날짜 지정',
    'alarm-type-monthly_end_relative': '매월 월말 계산',
    'alarm-label-holiday-adjustment': '비근무일 조정',
    'alarm-adj-none': '조정하지 않음',
    'alarm-adj-prev_business_day': '앞당기기(이전 근무일)',
    'alarm-adj-next_business_day': '뒤로 미루기(다음 근무일)',
    'alarm-adj-skip': '건너뛰기(실행하지 않음)',
    'alarm-adj-desc-none': '지정 날짜가 비근무일이어도 그대로 실행합니다.',
    'alarm-adj-desc-prev_business_day': '지정 날짜가 비근무일일 경우 직전의 근무일로 실행합니다.',
    'alarm-adj-desc-next_business_day': '지정 날짜가 비근무일일 경우 직후의 근무일로 실행합니다.',
    'alarm-adj-desc-skip': '지정 날짜가 비근무일일 경우 그 달/주의 실행을 건너뜁니다.',
    'label-day': '일',
    'label-before-end-1': '월말부터',
    'label-before-end-2': '일 전(0은 월말일)',
    ...
    'alarm-label-action-category': '시작할 카테고리',
    ...
    'alert-business-days-min': '근무 요일은 적어도 1개 이상 선택해 주십시오',
    'alarm-editor-select-prompt': '좌측부터 알람을 선택해 주십시오',
    'alarm-label-default-name': '알람 #{index}',
    'alarm-label-not-initialized': '(알람 #{index} - 초기화되지 않음)',
    'alarm-section-basic': '기본 설정',
    'alarm-section-action': '활동 설정',
    ...
    'theme-dark': '다크 모드',
    'setting-font': '표시 글꼴',
    'setting-font-weight': '글꼴 두께',
    'font-weight-normal': '표준',
    'font-weight-medium': '살짝 굵게',
    'font-weight-bold': '굵게',
    'font-weight-heavy': '매우 굵게',
    ...
    'setting-timer-height': '타이머 영역 높이',
    'timer-height-normal': '보통 (100%)',
    'timer-height-compact': '조금 낮게 (2/3)',
    'timer-height-mini': '더 낮게 (1/2)',
    'setting-animation-by-category': '배경 애니메이션 설정',
    'setting-history-csv': '작업 기록 (CSV)',
    'btn-export-csv': '내보내기',
    'btn-import-csv': '가져오기',
    // Categories Tab
    ...
    'btn-add-custom-anim': '커스텀 애니메이션 추가',
    ...
    'tooltip-font-weight-select': '글꼴 두께를 선택합니다',
    ...
    'tooltip-timer-height-select': '타이머 영역의 높이를 선택합니다',
    'tooltip-status-running': '실행 중',
    'tooltip-status-paused': '일시 중지됨',
    'tooltip-status-stopped': '종료됨',
    'tooltip-calendar': '날짜 선택',
    // Maintenance Tab
    'maintenance-clear-logs': '작업 기록',
    'maintenance-clear-categories': '분류',
    'maintenance-clear-settings': '설정',
    'maintenance-clear-alarms': '알람',
    'maintenance-clear-animations': '커스텀 애니메이션',
    'btn-clear-logs': '작업 기록 전부 삭제',
    'maintenance-sync-pull': '동기화 기록 다시 로딩',
    'btn-sync-pull': '동기화 기록 다시 로딩',
    'maintenance-sync-clear-cloud': '모든 동기화 장치로부터 기록을 전부 삭제',
    'btn-sync-clear-cloud': '모든 동기화 장치로부터 기록을 전부 삭제',
    'maintenance-reset-all': '설정 및 카테고리 초기화',
    'maintenance-reset-all-desc': '작업 기록은 유지됩니다.',
    'btn-reset-all': '모두 초기화',
    'btn-reset': '초기화',
    'btn-initialize-all': '전부 초기화',
    'btn-initialize': '초기화',
    ...
    'maintenance-backup-title': '백업 및 복구',
    'backup-start': '백업을 시작',
    'backup-execute': '백업',
    'backup-change-dir': '백업 위치를 변경',
    'restore-btn': '복구',
    'backup-status-success': '백업 완료',
    'backup-status-failed': '백업 실패',
    // Maintenance - 復元ダイアログ
    'confirm-restore': '데이터를 복구하시겠습니까?',
    'confirm-restore-desc':
        '현재의 모든 데이터가 삭제되고, 백업 데이터로 덮어쓰기됩니다. 이 작업은 되돌릴 수 없습니다.',
    // Maintenance - 復元メッセージ
    'restore-success': '복구가 완료됐습니다',
    'restore-error-invalid-folder': '유효한 백업 폴더가 아닙니다. 필수 파일을 찾을 수 없습니다.',
    'restore-error-write-failed': '복구중에 에러가 발생했습니다. 데이터가 불완전한 상태일 수 있습니다.',
    'restore-skipped-records': '{count}건의 올바르지 않은 레코드를 스킵했습니다',
    // Maintenance - 削除/初期化
    'maintenance-delete-title': '삭제 및 초기화',
    'maintenance-delete-execute': '삭제 및 초기화하기',
    'confirm-delete-initialize':
        '아래의 데이터를 삭제 및 초기화합니다:\n{items}\n\n이 작업은 되돌릴 수 없습니다. 정말로 실행하시겠습니까?',
    'maintenance-delete-success': '선택한 항목을 삭제 및 초기화합니다',
    'maintenance-delete-error': '{item}을(를) 삭제중에 에러가 발생했습니다',
    // Backup Tab
    'btn-backup-start': '백업 시작하기',
    'btn-backup-run': '백업 실행하기',
    'btn-backup-grant-run': '저장 위치에 접근해 백업을 저장하기',
    'btn-backup-change-dir': '백업 위치 변경',
    'backup-status-syncing': '백업중...',
    'backup-last-time': '최종 백업: {time}',
    'backup-directory': '디렉토리',
    'backup-not-selected': '(미선택)',
    'backup-file-count': '파일 수: {count}일치',
    'backup-file-count-unit': '일치',
    'backup-last-time-label': '최종 백업 시각',
    'backup-file-count-label': '기록 일수',
    ...
    'history-edit-title': '기록 편집',
    'history-edit-stop-title': '종료 편집',
    'history-action-title': '기록 조작',
    'history-edit-start-time': '시작 시간',
    'history-edit-end-time': '종료 시간',
    'history-edit-category': '카테고리',
    'history-edit-memo': '메모',
    'history-edit-out-of-range': '지정된 시간은 범위 밖입니다.',
    'placeholder-memo': '메모를 입력...',
    'confirm-delete-history': '이 기록을 삭제하시겠습니까?',
    'btn-apply': '적용',
    'btn-edit': '편집',
    'btn-split': '분할',
    'btn-delete': '삭제',
    'confirm-cancel': '취소',
    'confirm-discard-changes': '변경된 내용이 저장돼있지 않습니다. 변경된 내용을 삭제하고 닫으시겠습니까?',
    'confirm-delete-category': '"{name}" 카테고리를 삭제하시겠습니까?\n(이전 작업 기록의 카테고리 색상이 사라집니다)',
    'confirm-delete-selected': '선택한 {count}개 항목을 삭제하시겠습니까?',
    'confirm-import-overwrite': '기존 카테고리를 모두 삭제하고 덮어쓰시겠습니까?',
    'confirm-export-csv': '작업 기록 데이터를 CSV로 내보냅니다. 진행 중인 작업은 종료됩니다. 계속하시겠습니까?',
    'confirm-import-csv':
        'CSV에서 작업 기록 데이터를 가져옵니다. 기존 데이터에 추가됩니다. 진행 중인 작업은 종료됩니다. 계속하시겠습니까?',
    'confirm-clear-logs': '모든 작업 기록을 삭제합니다. 진행 중인 작업은 종료됩니다. 계속하시겠습니까?',
    'confirm-sync-pull':
        '로컬 작업 기록을 삭제하고, 다른 단말기와 공유된 기록 데이터로 다시 로딩합니다. 진행 중인 작업은 종료됩니다. 계속하시겠습니까?',
    'confirm-sync-clear-cloud':
        '이 단말기뿐만 아니라 동기화하고 있는 모든 장치로부터 작업 기록을 삭제합니다. 진행 중인 작업은 종료됩니다. 계속하시겠습니까?',
    'confirm-reset-all': '카테고리와 설정을 초기화합니다. 계속하시겠습니까? (작업 기록은 유지됨)',
    'confirm-reset-settings': '설정을 초기화합니다. 계속하시겠습니까? (작업 기록과 카테고리는 유지됨)',
    ...
    'toast-done-with-reopen-msg':
        '완료됐습니다! 설정 패널을 열고 있는 경우에는 새로운 애니메이션을 적용하기 위해 한 번 닫은 뒤 다시 열어주십시오.',
    ...
    'demo-warning': '💡 데모 작업 기록 (사용 전 유지 관리에서 삭제하십시오)',
    ...
    'init-tag-dev': '개발, 설계',
    'init-tag-meeting': '회의',
    'init-tag-research': '조사',
    'init-tag-admin': '사무',
    'init-tag-focus': '집중',
    'init-tag-skill': '자기계발',
    'init-tag-idea': '기획',
    'init-tag-break': '휴식',
    'init-tag-client': '고객응대',
    'init-tag-doc': '문서작성, 보고',
    'init-tag-design': '디자인',
    'init-tag-bug': '버그수정',
    'init-tag-release': '릴리스',
    'init-tag-tool': '도구',
    'init-tag-schedule': '관리',
    'init-tag-chat': '채팅',
    'init-tag-wiki': '문서',
    'init-tag-qa': '테스트',
    'init-tag-sales': '영업',
    ...
    'setting-session-sync': '단말기간 동기화 (Sync) (β)',
    'setting-session-sync-desc': '브라우저의 동기화 기능을 이용해 설정·카테고리·최근 이력을 다른 단말기와 공유합니다.',
    'setting-session-sync-note': '※ Chrome과 Edge 간 등 다른 브라우저 간에서의 동기화는 할 수 없습니다.',
    'confirm-enable-session-sync':
        '단말기간 동기화를 활성화하시겠습니까? 현재 데이터가 브라우저 동기화 저장소에 업로드됩니다.',
    'confirm-disable-session-sync':
        '단말기간 동기화를 비활성화하시겠습니까? 이 단말기에서의 동기화는 정지됩니다만, 다른 단말기와 공유된 데이터는 유지됩니다.',
    'session-sync-active': '동기화 활성화',
    'local-only-active': '로컬 완결',
    'sync-setup-title': '단말기간 동기화 설정',
    'sync-setup-desc': '동기화를 시작하기에 앞서, 기존 데이터와 다른 단말기의 데이터의 우선순위를 선택해 주십시오.',
    ...
    'tab-custom-anim': '커스텀 애니메이션',
    'custom-anim-select-label': '등록된 커스텀 애니메이션',
    'custom-anim-import': '불러오기 (추가)',
    'btn-add-from-file': '파일에서 불러오기',
    'btn-add-from-clipboard': '클립보드에서 불러오기',
    'custom-anim-export': '내보내기',
    'btn-save-to-file': '파일에 저장',
    'btn-copy-to-clipboard': '클립보드에 복사',
    'custom-anim-delete-label': '삭제',
    'btn-delete-selected-anim': '선택한 애니메이션 삭제',
    'toast-custom-anim-imported': '커스텀 애니메이션을 불러왔습니다',
    'toast-custom-anim-exported': '커스텀 애니메이션을 클립보드에 복사했습니다',
    'confirm-delete-custom-anim':
        "커스텀 애니메이션 '{name}'을(를) 삭제하시겠습니까?\n(이 애니메이션이 할당된 모든 카테고리 설정은 '없음'으로 변경됩니다)",
    'alert-invalid-qlanim': '맞지 않는 .qlanim 형식입니다. 파일 구조를 확인해 주십시오.',
    'btn-launch-maker': '애니메이션 메이커를 기동',
    'maker-title': '애니메이션 메이커',
    'placeholder-meta-name': '마이 애니메이션',
    'placeholder-meta-author': '당신의 이름',
    'placeholder-meta-desc': '애니메이션의 간단 설명',
    'maker-overflow-behavior': '나열해 배치',
    'maker-max-width': '최대 폭 (maxWidth)',
    'maker-scale-with-height': '높이에 연동해서 확대 및 축소',
    'maker-invert': '음양 반전',
    'maker-brightness': '밝기',
    'maker-gif-import': 'GIF 이미지 가져오기',
    'maker-drop-hint': '여기에 애니메이션 GIF를 드롭하거나 클릭해 선택해주십시오',
    'maker-file-name': '파일명:',
    'maker-dimensions': '해상도:',
    'maker-frames-count': '프레임 수:',
    'maker-spec-monitor': '실시간 스펙 모니터',
    'maker-current-scale': '현재 배율',
    'maker-target-height': '타깃 높이',
    'maker-boundary-height': '보조선 높이 (가이드 표시)',
    'maker-drag-instruction': '이미지를 드래그해 위치를 조정할 수 있습니다',
    'maker-zoom-in': '확대',
    'maker-zoom-out': '축소',
