export default {
    ...
    'maintenance-sync-pull': '从会话重新获取工作历史',
    'btn-sync-pull': '会话信息初始化',
    'maintenance-sync-clear-cloud': '删除会话中的工作历史',
    'btn-sync-clear-cloud': '删除会话中的所有工作历史',
    ...
    'confirm-sync-pull': '将删除本地工作历史并从会话信息重新获取。当前任务将结束。是否继续？',
    'confirm-sync-clear-cloud': '将删除会话和本地的所有工作历史。当前任务将结束。是否继续？',
    ...
    'setting-session-sync': '会话同步 (Sync) (β)',
    'setting-session-sync-desc': '利用浏览器会话功能，安全地同步设置、分类和近期历史记录。',
