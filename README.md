...
詳細な設計思想、技術選定、および実装の背景については製品仕様書 [docs/spec.md](docs/spec.md) を、行動指針については [AGENTS.md](AGENTS.md) を参照してください。
