![Version](https://img.shields.io/badge/version-1.1.13-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Privacy](https://img.shields.io/badge/Privacy-Local%20Only-brightgreen) ![Manifest V3](https://img.shields.io/badge/Manifest-V3-orange) [![Chrome Web Store](https://img.shields.io/chrome-web-store/v/kllhfalcincleolgoepnailfjendigdh?logo=google-chrome&logoColor=white&label=Chrome%20Web%20Store)](https://chrome.google.com/webstore/detail/kllhfalcincleolgoepnailfjendigdh) [![Crowdin](https://badges.crowdin.net/quicklog-solo/localized.svg)](https://crowdin.com/project/quicklog-solo) [![Audit](https://github.com/masanori-satake/QuickLog-Solo/actions/workflows/audit.yml/badge.svg)](https://github.com/masanori-satake/QuickLog-Solo/actions/workflows/audit.yml) [![pre-commit.ci status](https://results.pre-commit.ci/badge/github/masanori-satake/QuickLog-Solo/main.svg)](https://results.pre-commit.ci/latest/github/masanori-satake/QuickLog-Solo/main) [![Quality](https://github.com/masanori-satake/QuickLog-Solo/actions/workflows/test_quality.yml/badge.svg)](https://github.com/masanori-satake/QuickLog-Solo/actions/workflows/test_quality.yml) [![Web Deploy](https://github.com/masanori-satake/QuickLog-Solo/actions/workflows/release_web_deploy.yml/badge.svg)](https://github.com/masanori-satake/QuickLog-Solo/actions/workflows/release_web_deploy.yml)
...
- **徹底したプライバシーと透明性:**
- **プライバシー第一:** 外部通信を遮断し、データはすべてローカル（IndexedDB）に保存されます。詳細は [製品仕様書 (spec.md)](docs/spec.md) の「プライバシー」セクションを参照してください。
- **ピュアで長寿命な設計:** 外部ライブラリを使用しない Vanilla JS 構成。依存関係によるブラックボックスを排除し、長期的な保守性と透明性を確保しています。
- **厳格な監査:** Google OSV-Scanner による脆弱性検査と、CI による整合性チェックを継続的に実施しています。
...
本プロジェクトは、ユーザーのプライバシー保護と技術的な透明性を最優先しています。具体的なセキュリティ基準や設計思想については、[製品仕様書 (spec.md)](docs/spec.md) および [透明性レポート](https://github.com/masanori-satake/QuickLog-Solo/actions/workflows/audit.yml) を参照してください。

This project prioritizes user privacy and technical transparency. For detailed security standards and design philosophy, please refer to the [Technical Specification (spec.md)](docs/spec.md) and the [Transparency Report](https://github.com/masanori-satake/QuickLog-Solo/actions/workflows/audit.yml).

- **外部通信ゼロ / Zero External Communication:** CSP により技術的に外部通信を遮断。
- **トラッキングなし / No Tracking:** 広告や解析コードは一切含まれません。
- **オープンソース / Open Source:** 誰でもコードを検証可能であり、依存関係も最小限に抑えられています。
